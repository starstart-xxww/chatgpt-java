...
import com.starstart.chatgpt.api.Api;
...
import com.starstart.chatgpt.exception.ChatException;
import com.starstart.chatgpt.util.fastjson.JSON;
import com.starstart.chatgpt.util.FormatDateUtil;
...
public class ChatGPT {
    ...
    public String chat(String message) {
        ...
        return response.getChoices().get(0).getMessage().getContentStr();
    }
    ...
    public BigDecimal balance() {
        ...
        Single<UseageResponse> usage = apiClient.usage(FormatDateUtil.formatDate(start), FormatDateUtil.formatDate(end));
